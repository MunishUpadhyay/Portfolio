...
export const Footer = ({ setCurrentPage }: FooterProps) => {
  ...
  return (
    <footer className="relative mt-8 md:mt-12 w-full bg-zinc-950/60 backdrop-blur-xl border-t-2 border-purple-500/20 overflow-hidden z-10">
      ...
      <div className="max-w-6xl mx-auto px-6 py-16 md:py-24 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 text-left mb-10 border-b-2 border-zinc-900/60 pb-10">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <ul className="space-y-3 text-sm text-foreground/80 font-normal">
              <li className="flex items-center gap-2.5 hover:text-white transition-colors min-w-0">
                ...
                <a href={`mailto:${personalInfo.email}`} className="hover:underline text-xs lg:text-sm whitespace-nowrap">
                  {personalInfo.email}
                </a>
              </li>
